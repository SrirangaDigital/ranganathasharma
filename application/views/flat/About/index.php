<div class="container"><br />
	<nav class="nav nav-tabs justify-content-around about-tabs" id="myTab" role="tablist">
		<a class="col-md-2 nav-item nav-link active" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="true">ಶರ್ಮರ ಪರಿಚಯ</a>
		<a class="col-md-2 nav-item nav-link" id="nav-article-tab" data-toggle="tab" href="#nav-article" role="tab" aria-controls="nav-article" aria-selected="false">ಶರ್ಮರ ಕೃತಿಗಳು</a>
		<a class="col-md-2 nav-item nav-link" id="nav-paper-article-tab" data-toggle="tab" href="#nav-paper-article" role="tab" aria-controls="nav-paper-article" aria-selected="false">ಪತ್ರಿಕಾ ವರದಿಗಳು</a>
	</nav>
	<div class="tab-content about-content" id="nav-tabContent">
		<div class="tab-pane fade show active mt-3" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
			<!-- about -->
