		...
		<div class="col-md-12 align-self-center">
			<div class="container bio">
				...
				<div class="row text-left">
					<div class="col-md-4">
						<ul>
							<li class="sanskrit"><a href="<?=BASE_URL?>listing/toc/095">अनुवादप्रदीपः - १</a></li>
							<li class="sanskrit"><a href="<?=BASE_URL?>listing/toc/096">अनुवादप्रदीपः - २</a></li>
							<li class="sanskrit"><a href="<?=BASE_URL?>listing/toc/103">एकचक्रम्</a></li>
							<li class="sanskrit"><a href="<?=BASE_URL?>listing/toc/087">काव्योद्यानम्</a></li>
							...
							<li class="sanskrit"><a href="<?=BASE_URL?>listing/toc/101">संस्कृत संमेलनम् अध्यक्षभाषणम्</a></li>
							<li class="sanskrit"><a href="<?=BASE_URL?>listing/toc/099">संस्कृतं नाम दैवी वाक्</a></li>
							<li class="sanskrit"><a href="<?=BASE_URL?>listing/toc/092">संस्कृतभाषादीपिका  - १</a></li>
					...
					<div class="col-md-4">
						<ul>
							...
							<li><a href="<?=BASE_URL?>listing/toc/078">ಹದಿಬದೆಯ ಧರ್ಮ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/079">ಹರಿಭಕ್ತಿಸಾರ</a></li>
							<li>ಹರಿಭಕ್ತಿಸಾರ</li>
