	...
	<div class="row justify-content-center overlay">
		<div class="col-md-12 align-self-center">
			<div class="container bio">
				<h2 class="text-center my-3">‘ಅ’ ಕಾರಾದಿ</h2>
				<div class="row">
					<div class="col-md-4">
						<ul>
							<li><a href="<?=BASE_URL?>listing/toc/095">ಅನುವಾದ ಪ್ರದೀಪಃ -೧</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/096">ಅನುವಾದ ಪ್ರದೀಪಃ-೨</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/074">ಅಮರಕೋಶ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/038">ಆಸ್ತಿಕ ಪರ್ವ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/075">ಉತ್ತರಗೀತಾಭಾಷ್ಯ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/040">ಉಪನಿಷತ್ತಿನ ಕಥೆಗಳು</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/087">ಕಾವ್ಯೋದ್ಯಾನಮ್</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/073">ಗೀತಸಪ್ತಕ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/127">ಚಾಮರಾಜೋಕ್ತಿ ವಿಲಾಸ </a></li>
							...
							<li><a href="<?=BASE_URL?>listing/toc/090">ಭಾಷಾಂತರ ಪಾಠ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/004">ಮರುಳ ಮುನಿಯನ ಕಗ್ಗ </a></li>
							<li><a href="<?=BASE_URL?>listing/toc/047">ಮಾಂಡೂಕ್ಯಪ್ರವಚನ</a></li>
					...
					<div class="col-md-4">
						<ul>
							...
							<li><a href="<?=BASE_URL?>listing/toc/025">ವಾಲ್ಮೀಕಿ ಮುನಿಗಳ ಹಾಸ್ಯ ಪ್ರವೃತ್ತಿ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/034">ವಾಲ್ಮೀಕಿ ರಾಮಾಯಣದ ನಾಲ್ಕು ಪಾತ್ರಗಳು</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/033">ವಾಲಿವಧಪ್ರಸಂಗ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/080">ವಿದುರ ನೀತಿ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/046">ವೀರಕಂಪಣರಾಯ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/005">ವೇದ -ವೇದಾಂತ</a></li>
					...
					<div class="col-md-4">
						<ul>
							...
							<li>ಶ್ರೀರಾಮಚಂದ್ರ</li>
							<li><a href="<?=BASE_URL?>listing/toc/071">ಶ್ರೀವಿಷ್ಣುಪುರಾಣ - ೨</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/070">ಶ್ರೀವಿಷ್ಣುಪುರಾಣ- ೧</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/055">ಶ್ರೀಶಂಕರಚರಿತಾಮೃತಮ್</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/104">ಶ್ರೀಶಾಂಕರ ಸೂಕ್ತಿ ಮಣಿಹಾರಃ </a></li>
							<li><a href="<?=BASE_URL?>listing/toc/082">ಶ್ರುತಿ ಸಾರ ಸಮುದ್ಧರಣಮ್</a></li>
							...
							<li><a href="<?=BASE_URL?>listing/toc/089">ಸಂಸ್ಕೃತ ಪ್ರಥಮ ಪ್ರವೇಶ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/092">ಸಂಸ್ಕೃತ ಭಾಷಾ ದೀಪಿಕಾ -೧</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/093">ಸಂಸ್ಕೃತ ಭಾಷಾ ದೀಪಿಕಾ-೨</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/094">ಸಂಸ್ಕೃತ ಭಾಷಾ ದೀಪಿಕಾ-೨</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/002">ಸಂಸ್ಕೃತ ಭಾಷಾಶಾಸ್ತ್ರ ಮತ್ತು ಸಾಹಿತ್ಯ ಚರಿತ್ರೆ</a></li>
							...
							<li><a href="<?=BASE_URL?>listing/toc/078">ಹದಿ ಬದೆಯ ಧರ್ಮ</a></li>
							<li><a href="<?=BASE_URL?>listing/toc/079">ಹರಿಭಕ್ತಿ ಸಾರ</a></li>
							<li>ಹರಿಭಕ್ತಿ ಸಾರ</li>
