<div class="container">
	...
	<div class="row mt-5 awards">
		...
		<div class="col-md-6">
			<div class="row">
				<div class="col-md-4 text-center"><img class="img-thumbnail" src="<?=IMAGE_URL?>awards2.jpg?v=1.0" alt="ರಂಗನಾಥಶರ್ಮಾ"></div>
				<div class="col-md-4 text-center"><img class="img-thumbnail" src="<?=IMAGE_URL?>awards3.jpg?v=1.0" alt="ರಂಗನಾಥಶರ್ಮಾ"></div>
