				...
				<div class="tab-content">
					<div id="kannada" class="container tab-pane active"><br>
						<div class="row">
							...
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/062"><img src="<?=IMAGE_URL?>books/062.jpg" alt="Books images" /><h5 class="card-title">ಅರಣ್ಯ ಕಾಂಡ</h5></a>
							</div>
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/063"><img src="<?=IMAGE_URL?>books/063.jpg" alt="Books images" /><h5 class="card-title">ಕಿಷ್ಕಿಂಧಾ ಕಾಂಡ</h5></a>
							</div>
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/064"><img src="<?=IMAGE_URL?>books/064.jpg" alt="Books images" /><h5 class="card-title">ಯುದ್ಧಕಾಂಡ -೧</h5></a>
							</div>
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/065"><img src="<?=IMAGE_URL?>books/065.jpg" alt="Books images" /><h5 class="card-title">ಯುದ್ಧಕಾಂಡ-೨</h5></a>
							</div>
							<div class="col-md-2 booksCollection">
							...
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/066"><img src="<?=IMAGE_URL?>books/066.jpg" alt="Books images" /><h5 class="card-title">ಉತ್ತರ ಕಾಂಡ</h5></a>
							</div>
							<div class="col-md-2 booksCollection">
							...
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/082"><img src="<?=IMAGE_URL?>books/082.jpg" alt="Books images" /><h5 class="card-title">ಶ್ರುತಿ ಸಾರ ಸಮುದ್ಧರಣಮ್</h5></a>
							</div>
							<div class="col-md-2 booksCollection">
							...
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/104"><img src="<?=IMAGE_URL?>books/104.jpg" alt="Books images" /><h5 class="card-title">ಶ್ರೀಶಾಂಕರ ಸೂಕ್ತಿ ಮಣಿಹಾರಃ</h5></a>
							</div>
							<div class="col-md-2 booksCollection">
							...
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/078"><img src="<?=IMAGE_URL?>books/078.jpg" alt="Books images" /><h5 class="card-title">ಹದಿ ಬದೆಯ ಧರ್ಮ</h5></a>
							</div>
							<div class="col-md-2 booksCollection">
					...
					<!-- <div id="sanskrit" class="container tab-pane fade"><br>
						<div class="row">
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/072"><img src="<?=IMAGE_URL?>books/072.jpg" alt="Books images" /><h5 class="card-title">ನಾರದ</h5></a>
							</div>	
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/091"><img src="<?=IMAGE_URL?>books/091.jpg" alt="Books images" /></a>
							</div>	
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/055"><img src="<?=IMAGE_URL?>books/055.jpg" alt="Books images" /></a>
							</div>	
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/087"><img src="<?=IMAGE_URL?>books/087.jpg" alt="Books images" /></a>
							</div>	
							<div class="col-md-2 booksCollection">
								<a href="<?=BASE_URL?>listing/toc/089"><img src="<?=IMAGE_URL?>books/089.jpg" alt="Books images" /></a>
							</div>
						</div>	
					</div> -->
				</div>
